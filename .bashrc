...
# creates an alias for accessing the windows files (specifically in OneDrive)
alias winfiles='cd .. && cd mnt/c/Users/Arjun\ Bhamra/OneDrive'

# creates alias for research access
alias research='cd research_qwerty/qwerty && . venv/bin/activate'
